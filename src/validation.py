...
def expanding_window_validation(
    ...
    while test_end_idx <= n_timestamps:
        ...
        train_mask = data_masked[timestamp_col].isin(unique_timestamps[train_start_idx:train_end_idx])
        val_mask = data_masked[timestamp_col].isin(unique_timestamps[val_start_idx:val_end_idx])
        test_mask = data_masked[timestamp_col].isin(unique_timestamps[test_start_idx:test_end_idx])
